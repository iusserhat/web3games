...
var init_version7 = __esm({
  "node_modules/@ethersproject/abstract-provider/lib.esm/_version.js"() {
    version7 = "abstract-provider/5.8.0";
  }
});

// node_modules/@ethersproject/abstract-provider/lib.esm/index.js
var __awaiter2, logger7, ForkEvent, Provider;
var init_lib8 = __esm({
  "node_modules/@ethersproject/abstract-provider/lib.esm/index.js"() {
    "use strict";
    init_lib3();
    ...
    Provider = class _Provider {
      constructor() {
        logger7.checkAbstract(new.target, _Provider);
...
var __awaiter3, logger9, padding, NegativeOne3, Zero3, One2, MaxUint2562, hexTrue, hexFalse, domainFieldTypes, domainFieldNames, domainChecks, TypedDataEncoder;
...
var logger12, TransactionTypes, transactionFields, allowedTransactionKeys;
...
var __awaiter4, logger13, allowedTransactionKeys2, forwardErrors, Signer, VoidSigner;
      ...
      checkTransaction(transaction) {
        for (const key2 in transaction) {
          if (allowedTransactionKeys2.indexOf(key2) === -1) {
            logger13.throwArgumentError("invalid transaction key: " + key2, "transaction", transaction);
          }
        }
        ...
        if (tx.from == null) {
          ...
          tx.from = Promise.all([
            ...
            if (result[0].toLowerCase() !== result[1].toLowerCase()) {
              logger13.throwArgumentError("from address mismatch", "transaction", transaction);
            }
            return result[0];
          });
        }
      ...
      populateTransaction(transaction) {
        return __awaiter4(this, void 0, void 0, function* () {
          ...
          if (tx.gasPrice != null && (tx.type === 2 || hasEip1559)) {
            logger13.throwArgumentError("eip-1559 transaction do not support gasPrice", "transaction", transaction);
          } else if ((tx.type === 0 || tx.type === 1) && hasEip1559) {
            logger13.throwArgumentError("pre-eip-1559 transaction do not support maxFeePerGas/maxPriorityFeePerGas", "transaction", transaction);
          }
          ...
          if (tx.chainId == null) {
            ...
            tx.chainId = Promise.all([
              ...
              if (results[1] !== 0 && results[0] !== results[1]) {
                logger13.throwArgumentError("chainId address mismatch", "transaction", transaction);
              }
              return results[0];
            });
          }
...
js-sha3/src/sha3.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-B4BE72TJ.js.map
